...
private:
  ...
  ///
  //std::queue< Ptr<Packet> > overheard_queue;
  //std::queue< Mac48Address> mac_queue;
  ///
  ...
  ///
  ///
  Ptr<Packet> undo_xor_packets (const Ptr<Packet> & xor_packet);
  //queue of headers
  queue <WifiMacHeader> queue_hdr;
  //queue of packets
  queue < Ptr<Packet> > queue_packets;
  
  //queue of packets overheard_queue
  queue < Ptr<Packet> > queue_packets_overheard;
  //queue of headers corresponding to overheard packets
  queue <WifiMacHeader> queue_hdr_overheard;
